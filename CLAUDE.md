...
`meteo` sind die Referenz: 30 Grad, klarer Himmel, 12:01 auf der Uhr in
`meteo`. Gemeint ist die Zeit *im* Bild, nicht die des Auslösens — nur die kann
treffen, wer eine Aufnahme nachzieht. Persona durchgehend Martin.
